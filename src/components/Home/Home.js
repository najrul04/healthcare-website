        ...
        <h1 className='my-3'>Latest News</h1>
          ...
          <Card className="card_latest shadow-lg">
           <Card.Body>
             ...
             <Button className='py-1 rounded bg-primary text-white' variant="primary"><a  rel='noreferrer' className='text-decoration-none text-white' target='_blank' href="https://health.usnews.com/conditions/articles/a-beginners-guide-to-a-virtual-doctors-visit">See more</a></Button>
           </Card.Body>
         </Card>
         </Col>
          ...
          <Card className="card_latest shadow-lg">
           <Card.Body>
            ...
            <Button className='py-1 rounded bg-primary text-white' variant="primary"><a rel='noreferrer' className='text-decoration-none text-white' target='_blank' href="https://www.dana-farber.org/find-a-doctor/william-g-kaelin-jr/">See more</a></Button>
            </Card.Body>
            </Card>
            </Col>
            ...
            <Button className='py-1 rounded bg-primary text-white' variant="primary"><a  rel='noreferrer' className='text-decoration-none text-white' target='_blank' href="https://www.nobelprize.org/prizes/medicine/2018/allison/facts/">See more</a></Button>
            </Card.Body>
            </Card>
            </Col>
            ...
            <Button className='py-1 rounded bg-primary text-white' variant="primary"><a  rel='noreferrer' className='text-decoration-none text-white' target='_blank' href="https://www.nobelprize.org/prizes/medicine/2017/rosbash/facts/">See more</a></Button>
            </Card.Body>
            </Card>
            </Col>
